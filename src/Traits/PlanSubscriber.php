...
namespace Alalm3i\LaravelSubscription\Traits;
...
trait PlanSubscriber
{
     ...
     *
     * @param  string  $name
     * @return \Alalm3i\LaravelSubscription\Models\PlanSubscription|null
     */
     ...
     *
     * @param  string  $subscription
     * @return \Alalm3i\LaravelSubscription\SubscriptionUsageManager
     */
