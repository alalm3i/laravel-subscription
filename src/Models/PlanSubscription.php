...
use Alalm3i\LaravelSubscription\Database\Factories\PlanSubscriptionFactory;
use Alalm3i\LaravelSubscription\Events\SubscriptionCanceled;
use Alalm3i\LaravelSubscription\Events\SubscriptionCreated;
use Alalm3i\LaravelSubscription\Events\SubscriptionRenewed;
use Alalm3i\LaravelSubscription\Events\SubscriptionSaved;
use Alalm3i\LaravelSubscription\Events\SubscriptionSaving;
use Alalm3i\LaravelSubscription\Period;
use Alalm3i\LaravelSubscription\SubscriptionAbility;
use Alalm3i\LaravelSubscription\SubscriptionUsageManager;
...
class PlanSubscription extends Model implements PlanSubscriptionInterface
{
     ...
     *
     * @var Alalm3i\LaravelSubscription\SubscriptionAbility
     */
    protected $ability;
     ...
     *
     * @return \Alalm3i\LaravelSubscription\SubscriptionAbility
     */
