...
namespace Alalm3i\LaravelSubscription\Tests;
...
class TestCase extends Testbench
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        // Set user model
        $app['config']->set('auth.providers.users.model', '\Alalm3i\LaravelSubscription\Tests\Models\User');
    ...
    {
        return ['Alalm3i\LaravelSubscription\SubscriptionServiceProvider'];
    }
